...
function fillStatic(data) {
    ...
    item[0].children.item(1).innerHTML = data.length;
...
function drawMap() {
    var dom = document.getElementById("wxb_home_map");
        ...
        series: [
            {
                ...
                data:[
                    {value:123234, name:'已处理数据'},
                    {value:13103, name:'正在处理中'},
                    {value:82133, name:'待处理'}
                ]
            }
        ]
    };
...
function initRightPanelList() {
    document.querySelectorAll('#wxb_home_rightpanel table:nth-of-type(1) tr').forEach(e => {
...
function autoIncrease(ele) {
    if(Math.random() > 0.5) {
        ele.innerHTML = Number(ele.innerHTML) + Math.ceil(Math.random()*10);
        ele.setAttribute('class', 'flipInX');
        setTimeout(function(ele){
            ele.removeAttribute('class');
        }, 1000, ele)
    }
}
setInterval(autoIncrease, 1500, document.querySelector('#wxb_home_static_table tr:nth-of-type(4) td:nth-of-type(2)'));
setInterval(autoIncrease, 1500, document.querySelector('#wxb_home_static_table tr:nth-of-type(2) td:nth-of-type(2)'));
setInterval(autoIncrease, 1500, document.querySelector('#wxb_home_static_table tr:nth-of-type(3) td:nth-of-type(2)'));
setInterval(autoIncrease, 1500, document.querySelector('#wxb_home_static_table tr:nth-of-type(6) td:nth-of-type(2)'));
setInterval(autoIncrease, 1500, document.querySelector('#wxb_home_static_table tr:nth-of-type(7) td:nth-of-type(2)'));

setInterval(autoIncrease, 1500, document.querySelector('#wxb_home_rightpanel_uptable tr:nth-of-type(2) td:nth-of-type(3)'));
setInterval(autoIncrease, 1500, document.querySelector('#wxb_home_rightpanel_uptable tr:nth-of-type(3) td:nth-of-type(3)'));
setInterval(autoIncrease, 1500, document.querySelector('#wxb_home_rightpanel_uptable tr:nth-of-type(4) td:nth-of-type(3)'));
setInterval(autoIncrease, 1500, document.querySelector('#wxb_home_rightpanel_uptable tr:nth-of-type(5) td:nth-of-type(3)'));
